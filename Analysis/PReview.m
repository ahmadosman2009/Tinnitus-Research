...
postreviewFig = figure('MenuBar', 'None', 'Units', 'normalized', 'Name', 'Review', ...
...
hndl.general.file.PathNRe = 'C:\AMFR\Review';
...
hndl.setting.criteria.NBlocks = 5;

hndl.uicontrol.control.NBlocks_TX = uicontrol('Parent', hndl.uipanel.criteria_PN, ...
    'Style', 'text', 'String', '# of Blocks to Stop', 'Units', 'normalized', ...
    'Fontsize', 12, 'Position', [0.1 0.6 0.6 0.08]);

hndl.uicontrol.control.NBlocks_ED = uicontrol('Parent', hndl.uipanel.criteria_PN, ...
    'Style', 'edit', 'String', hndl.setting.criteria.NBlocks, ...
    'Units', 'normalized', ...
    'Fontsize', 12, 'Position', [0.7 0.6 0.1 0.08], ...
    'Callback', @PBlocks_ED_prs);
