function modulationFrequencyStart_prs(obj, evt, stage)
    ...
    case 1        
        if tmp >= 60
            if mod(tmp, 60) == 0
                ...
                set(obj, 'String', hndl.setting.Pre.modulation.frequencyStart_P);
                return;
            end
        else
            if mod(60, tmp) == 0
        ...
        if (hndl.setting.Pre.modulation.Num_CK && ...
                (tmp > hndl.setting.Pre.modulation.frequencyEnd_P))
            warndlg('Be no GREATER than Start Frequency', 'Warning');
            
            set(obj, 'String', hndl.setting.Pre.modulation.frequencyStart_P);
            return;
        end
        
        hndl.setting.Pre.modulation.frequencyStart_P = tmp;
        ...
        hndl.setting.Post.modulation.frequencyStart_P = hndl.setting.Pre.modulation.frequencyStart_P;
        set(hndl.uicontrol.Post.modulation.modulationFrequencyStart_ED, 'String', hndl.setting.Post.modulation.frequencyStart_P);
    ...
    case 2        
        if tmp >= 60
            if mod(tmp, 60) == 0
                ...
                set(obj, 'String', hndl.setting.LDur.modulation.frequencyStart_P);
                return;
            end
        else
            if mod(60, tmp) == 0
        ...
        if (hndl.setting.LDur.modulation.Num_CK && ...
                (tmp > hndl.setting.LDur.modulation.frequencyEnd_P))
            warndlg('Be no GREATER than Start Frequency', 'Warning');
        ...
        hndl.setting.LDur.modulation.frequencyStart_P = tmp;
    ...
    case 3        
        if tmp >= 60
            if mod(tmp, 60) == 0
                ...
                set(obj, 'String', hndl.setting.Post.modulation.frequencyStart_P);
                return;
            end
        else
            if mod(60, tmp) == 0
        ...
        if (hndl.setting.Post.modulation.Num_CK && ...
                (tmp > hndl.setting.Post.modulation.frequencyEnd_P))
            warndlg('Be no GREATER than Start Frequency', 'Warning');
        ...
        hndl.setting.Post.modulation.frequencyStart_P = tmp;
